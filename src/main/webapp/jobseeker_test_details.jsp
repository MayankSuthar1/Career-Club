...
String sql ="select * from admin_test_detail where title = '"+request.getParameter("title")+"' ";
	...
	<div class="five columns">
		...
		<div class="widget">
			...
			<div class="job-overview">
				...
				<a href="#small-dialog" class="popup-with-zoom-anim button">Apply For This Test</a>

				<div id="small-dialog" class="zoom-anim-dialog mfp-hide apply-popup">
					<div class="small-dialog-headline">
						<h2>Apply For This Test</h2>
					</div>

					<div class="small-dialog-content">
						
							<a href="jobseeker_give_test.jsp?title=<%= resultSet.getString("title")%>">
							<button>Apply</button>
							</a>
					</div>
