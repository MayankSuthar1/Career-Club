...
<div class="container">
	<div class="sixteen columns">
		...
		<!-- Logo -->
		<div id="logo">
			<h1><a href="index.html"><img src="jobseeker_look/images/logo.png" alt="Career Club" /></a></h1>
		</div>
		...
		<nav id="navigation" class="menu">
			<ul id="responsive">
				...
				<li><a href="jobseeker_login_register.html">For job seeker</a>
				
				</li>

				<li><a href="recruiter_login_register.html">For recruiters</a>
		...
		<ul>
			...
			<li data-fstransition="fade" data-transition="fade" data-slotamount="10" data-masterspeed="300">
				...
				<div class="caption sfb" data-x="center" data-y="370" data-speed="400" data-start="1600" data-easing="easeOutExpo">
					<a href="recruiter_login_register.html" class="slider-button">Create a job</a>
					<a href="jobseeker_login_register.html" class="slider-button">Book a test</a>
				</div>
			</li>
...
<div class="container">
	...
	<div class="padding-right">
		...
		<ul class="job-list">
			...
			<li><a href="jobseeker_login_register.html">
			...
			<li><a href="jobseeker_login_register.html">
				<img src="jobseeker_look/images/job-list-logo-04.png" alt="">
				<div class="job-list-content">
					<h4>Backend Development Test<span class="internship">Skill Test</span></h4>
					<div class="job-icons">
			...
			<li><a href="jobseeker_login_register.html">
				<img src="jobseeker_look/images/job-list-logo-05.png" alt="">
				<div class="job-list-content">
					<h4>Full Stack Development Test<span class="temporary">Skill Test</span></h4>
					<div class="job-icons">
		...
		<a href="jobseeker_login_register.html" class="button centered"><i class="fa fa-plus-circle"></i> Show More Tests</a>
