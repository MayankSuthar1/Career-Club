...
<div class="container">
	<div class="sixteen columns">
		...
		<!-- Logo -->
		<div id="logo">
			<h1><a href="index.html"><img src="recruiter_look/images/logo.png" alt="Career CLub" /></a></h1>
		</div>
	...
	<div class="my-account">
		...
		<div class="tabs-container">
			...
			<div class="tab-content" id="tab1" style="display: none;">
				...
				<form method="post" class="login" action="Rec_login">
				...
				<div class="tab-content" id="tab2" style="display: none;">
					...
					<form method="post" class="register" action="Rec_reg">
