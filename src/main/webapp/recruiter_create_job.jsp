...
%>
			...
			<div class="form">
				<h5>Your Email</h5>
				<input class="search-field" type="email"  value="<%=resultSet.getString("company_email") %>" name="email"/>
			</div>

			<!-- Title -->
			<div class="form">
				<h5>Job Title</h5>
				<input class="search-field" type="text" placeholder="" value="" name="job_title"/>
			</div>
